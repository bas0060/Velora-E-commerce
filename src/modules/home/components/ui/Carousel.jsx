    ...
    <div className="w-full">
      ...
      <div className="mb-4 flex items-center">
        ...
        <div className="ml-auto self-end flex gap-x-3">
          <button
            onClick={handlePrev}
            className="px-3 h-10 cursor-pointer md:h-full md:p-4 my-auto bg-white rounded-full shadow disabled:opacity-40 disabled:cursor-not-allowed"
            disabled={!hasItems}
          >
            <img
              src={chevLeft}
          ...
          <button
            onClick={handleNext}
            className="px-3 cursor-pointer h-10 md:h-full md:p-4 my-auto bg-white rounded-full shadow disabled:opacity-40 disabled:cursor-not-allowed"
            disabled={!hasItems}
          >
            <img
              src={chevRight}
